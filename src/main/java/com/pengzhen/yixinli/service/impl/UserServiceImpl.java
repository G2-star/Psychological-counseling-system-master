...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public PageInfo selectByUsername(String username, int page, int limit) {
        //进行分页
        PageHelper.startPage(page, limit);
    ...
    @Override
    public User registByUser(String username, String password) {
        return userMapper.registByUser(username, DigestUtils.md5DigestAsHex(password.getBytes()));
    }
