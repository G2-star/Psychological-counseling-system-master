...
public class NoticeController {
    ...
    public ServerLayResult<Notice> list(@RequestParam(value = "page", defaultValue = "1") Integer page,
        ...
        PageInfo notices = noticeService.selectByKeyWord(page, limit, keyword1, keyword2);
        ServerLayResult result = new ServerLayResult(0, "", notices.getTotal(), notices.getList());
        return result;
    }
