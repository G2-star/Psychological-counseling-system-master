...
//        return result;
        ...
        PageInfo articles =articleService.selectByKeyWord(page, limit, keyword1, keyword2, keyword3);
        ServerLayResult result = new ServerLayResult(0, "", articles.getTotal(), articles.getList());
        return result;
    }
